    ...
    if request.method == "POST":
        try:
            ...
            if check_1["date"][check_1.shape[0]-1] != check_2["date"][check_2.shape[0]-1]:
                ...
                price_title="預測 "+tomorrow_date_year+"-"+tomorrow_date_month+"-"+tomorrow_date_day+" 價格:"
            else:
                price_title="預測 "+check_2["date"][check_2.shape[0]-1]+" 價格:"
    ...
    if request.method == "POST":
        try:
            ...
            if check_1["date"][check_1.shape[0]-1] != check_2["date"][check_2.shape[0]-1]:
                ...
                tomorrow_date=today_date+oneday
                30_day=today_date+30day
                split_tomorrow_date=str(tomorrow_date).split("-")
                tomorrow_date_year=split_tomorrow_date[0]
                tomorrow_date_month=split_tomorrow_date[1]
                tomorrow_date_day=split_tomorrow_date[2]

                split_30_date=str(30_date).split("-")
                30_date_year=split_30_date[0]
                30_date_month=split_30_date[1]
                30_date_day=split_30_date[2]

                price_title="預測 "+tomorrow_date_year+"-"+tomorrow_date_month+"-"+tomorrow_date_day+" 到 "+30_date_year+"-"+30_date_month+"-"+30_date_day+" 價格:"
            else:
                today_date=datetime.date.today()
                30day=datetime.timedelta(days=39)
                30_day=today_date+30day
                split_30_date=str(30_date).split("-")
                30_date_year=split_30_date[0]
                30_date_month=split_30_date[1]
                30_date_day=split_30_date[2]
                price_title="預測 "+check_2["date"][check_2.shape[0]-1]+" 到 "+30_date_year+"-"+30_date_month+"-"+30_date_day+" 價格:"
    ...
    if request.method == "POST":
        try:
            ...
            if check_1["date"][check_1.shape[0]-1] != check_2["date"][check_2.shape[0]-1]:
                ...
                price_title="兩市場 "+tomorrow_date_year+"-"+tomorrow_date_month+"-"+tomorrow_date_day+" 到 "+30_date_year+"-"+30_date_month+"-"+30_date_day+" 價格:"
            else:
                today_date=datetime.date.today()
                30day=datetime.timedelta(days=39)
                30_day=today_date+30day
                ...
                30_date_month=split_30_date[1]
                30_date_day=split_30_date[2]
                price_title="兩市場 "+check_2["date"][check_2.shape[0]-1]+" 到 "+30_date_year+"-"+30_date_month+"-"+30_date_day+" 價格:"
